    ...
    <>
      <Container className="mb-20 xl:mb-10 mt-40 md:mt-20 lg:mt-16 flex flex-col items-center">
        ...
        <div className="flex shrink flex-col items-center gap-16 xl:grid xl:grid-cols-12 xl:grid-rows-4">
          ...
          >
            A small-scale annual event welcoming diverse school delegations to a day of vibrant
            debate!
          </EventTypeCard>
          <EventTypeCard
            ...
            imageURL={daysLogo}
          >
            An outreach event for any individual aged 15-17, wishing to participate in an EYP Cyprus
            event. Join us for a day of interactive Team-Building, immersive Committee Work and an
            engaging General Assembly! An outreach event for any individual aged 15-17, wishing to
            participate in an EYP Cyprus event. Join us for a day of interactive Team-Building,
            immersive Committee Work and an engaging General Assembly!
          </EventTypeCard>
          <EventTypeCard
            ...
            imageURL={ysLogo}
          >
            A 3-day conference inviting young individuals from 17-25 years old, to come together,
            discuss current affairs, exchange ideas and debate. No prior EYP experience is needed!
          </EventTypeCard>
          <EventTypeCard
            ...
            imageURL={nsLogo}
          >
            EYP Cyprus annual flagship event, welcoming over 200 participants to an intercultural
            space of interactive activities, productive dialogue and community!
          </EventTypeCard>
        </div>
